        ...
        <div className=" px-4 py-2 sm:px-6">
          ...
          <div className="flow-root">
            <ul role="list" className="-my-6 divide-y divide-gray-200">
              {items.map((item) => (
                <>
                  <Modal title={"Delete Cart Item"} message={"Are you sure to delete this item"} dangerOption={"Delete"} cancelOption={"Cancel"} dangerAction={(e) => handleRemove(item.id)} showModal={modal} cancelAction={() => showModal(null)} />
