              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                  ...
                  >
                    ...
                    aria-current="page"
                    className={`relative z-10 inline-flex items-center ${index+1 === page? 'bg-indigo-600 text-white':' text-slate-400' } cursor-pointer px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                    >
                      {index+1}
                        </div>
                     )
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div key={product.id} className="group relative p-2 border-solid border-2 border-gray-200 rounded-md">
                                ...
                                <div className="mt-4 flex justify-between">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        <StarIcon style={{"color":"gold"}} className="w-6 h-6 inline"/>
